...
|---|---|---|
| SimVReal corpus baseline | `VALIDATION_MATRIX.md`, `corpus_summary_2026_05_01.md` | 25-flight regression baseline (24 cases plus MESOS as flight 25; canonical v1.0 Zenodo values): 25/25 within +/-10 %, 15/25 within +/-5 %, avg abs error 4.49 %. |
