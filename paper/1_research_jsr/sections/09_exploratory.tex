...
The 25-flight headline corpus of Sec.~\ref{sec:corpus} is bounded above by Mach~4.33, so it
...
none of these flights enters any headline statistic of Sec.~\ref{sec:corpus}). Signed apogee
...
single defect in the aerodynamic models. The headline corpus of Sec.~\ref{sec:corpus} pairs each
...
established in Sec.~\ref{sec:corpus}, and the high-Mach reach demonstrated here is reported as
exploratory only.
