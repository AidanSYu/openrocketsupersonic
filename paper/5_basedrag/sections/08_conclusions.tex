...
the base-drag component the ablation subset is most sensitive to --- moves predicted apogee
by a mean of $8.10$~pp across the archived 24-flight mechanism-ablation subset
($23$ single-stage flights plus the AeroPac~104K two-stage closure; peaking at $39.5$~pp on
...
the same data at $4.4\%$ \cite{chapman1950,chapman1955}. The Chapman--Korst turbulent
