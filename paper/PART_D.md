...
\begin{tikzpicture}[font=\small, >=Latex]
  ...
  %% Symmetric rocket, centerline at y=0, half-height 0.7
  %% Nose tip at x=0, nose base at x=2, body x=2..7, fins x=6.7..8
  ...
  % Label placed well clear of the shock line (shock at x=4 is at y=5)
  \node[align=center, font=\scriptsize] at (4.1,2.9) {shoulder \\ PM fan};

  % Post-shock annotation (over body tube, right side)
  \node[align=left, font=\scriptsize] at (6.3,2.6)
    {post-shock:\\ $M_2<M_\infty$, $p_2>p_\infty$};

  % Freestream arrow (far right, at body centerline height)
